...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUPMGraphicsManager_ApplyPreset_Statics::NewProp_Preset = { "Preset", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPMGraphicsManager_eventApplyPreset_Parms, Preset), Z_Construct_UScriptStruct_FUPMQualityPreset, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Preset_MetaData), NewProp_Preset_MetaData) }; // 3465458098
...
struct Z_Construct_UFunction_UUPMGraphicsManager_SetFullscreenMode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UPM|Display" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/**\n\x09 * Sets the fullscreen mode\n\x09 * NOTE: Fullscreen changes do NOT work in PIE (Play In Editor).\n\x09 * You must test in Standalone Game or a packaged build.\n\x09 * Call ApplySettings() after this for the change to take effect.\n\x09 */" },
#endif
		{ "ModuleRelativePath", "Public/UPMGraphicsManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Sets the fullscreen mode\nNOTE: Fullscreen changes do NOT work in PIE (Play In Editor).\nYou must test in Standalone Game or a packaged build.\nCall ApplySettings() after this for the change to take effect." },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UFunction_UUPMGraphicsManager_SetResolutionScale_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UPM|Display" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Sets the resolution scale (25-100%) */" },
#endif
		{ "ModuleRelativePath", "Public/UPMGraphicsManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Sets the resolution scale (25-100%)" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UFunction_UUPMGraphicsManager_SetScreenResolution_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UPM|Display" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/**\n\x09 * Sets the screen resolution\n\x09 * NOTE: Resolution changes may not be visible in PIE.\n\x09 * Call ApplySettings() after this for the change to take effect.\n\x09 */" },
#endif
		{ "ModuleRelativePath", "Public/UPMGraphicsManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Sets the screen resolution\nNOTE: Resolution changes may not be visible in PIE.\nCall ApplySettings() after this for the change to take effect." },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UClass_UUPMGraphicsManager_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UUPMGraphicsManager_ApplyPreset, "ApplyPreset" }, // 2590634714
		...
		{ &Z_Construct_UFunction_UUPMGraphicsManager_GetCurrentSettingsAsPreset, "GetCurrentSettingsAsPreset" }, // 4040019958
		...
		{ &Z_Construct_UFunction_UUPMGraphicsManager_GetPresetByLevel, "GetPresetByLevel" }, // 1360584627
		...
		{ &Z_Construct_UFunction_UUPMGraphicsManager_SetFullscreenMode, "SetFullscreenMode" }, // 4032755465
		...
		{ &Z_Construct_UFunction_UUPMGraphicsManager_SetResolutionScale, "SetResolutionScale" }, // 2461212230
		{ &Z_Construct_UFunction_UUPMGraphicsManager_SetScreenResolution, "SetScreenResolution" }, // 2273137633
...
struct Z_CompiledInDeferFile_FID_Users_leonh_Documents_Unreal_Projects_StatSysFinalEnv_Plugins_UPM_Source_UPM_Public_UPMGraphicsManager_h__Script_UPM_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUPMGraphicsManager, UUPMGraphicsManager::StaticClass, TEXT("UUPMGraphicsManager"), &Z_Registration_Info_UClass_UUPMGraphicsManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUPMGraphicsManager), 2389102607U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_leonh_Documents_Unreal_Projects_StatSysFinalEnv_Plugins_UPM_Source_UPM_Public_UPMGraphicsManager_h__Script_UPM_2083777961(TEXT("/Script/UPM"),
