...
public:
	...
	/** Sets the resolution scale (25-100%) */
	UFUNCTION(BlueprintCallable, Category = "UPM|Display")
...
protected:
	...
	/** Mark that we have pending changes (local to this manager) */
	void MarkPendingChanges();

	/** Get the owning UPMCore (if any) */
	class UUPMCore* GetOwningCore() const;
